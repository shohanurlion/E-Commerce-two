  ...
  <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
      <div class="min-w-0 flex-1 space-y-8">
        ...
        <div className=''>
          <button className='w-[200px] h-[40px] border-2 border-[black] text-[black] cursor-pointer duration-700 ease-in-out hover:bg-[black] hover:text-[white]'>Peyment</button>
        </div>
      </div>
